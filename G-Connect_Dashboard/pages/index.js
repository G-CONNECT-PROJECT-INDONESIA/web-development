...
function onMessageArrived(message) {
  var parameters_json = JSON.parse(message.payloadString);
  const parameters = parseDataString(message.payloadString);

  // console.log("onMessageArrived: " + message.payloadString);
  console.log("onMessageArrived : " + JSON.stringify(parameters));
// for custom format
...
// for json format
  // document.getElementById("variabel-ws").innerHTML    = parameters_json.wind;
  // document.getElementById("variabel-hum").innerHTML   = parameters_json.hum;
  // document.getElementById("variabel-temp").innerHTML  = parameters_json.temp;
  // document.getElementById("variabel-soil").innerHTML  = parameters_json.soil;
  // document.getElementById("variabel-lat").innerHTML   = parameters_json.lat;
  // document.getElementById("variabel-long").innerHTML  = parameters_json.long;
  // document.getElementById("variabel-acx").innerHTML   = parameters_json.acx;
  // document.getElementById("variabel-acy").innerHTML   = parameters_json.acy;
  // document.getElementById("variabel-acz").innerHTML   = parameters_json.acx;
